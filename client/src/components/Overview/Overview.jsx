...
const Overview = ({ data }) => {
    const { beds, bath, balcony, area, costperarea, lift } = data || {}
        ...
        <div className="mt-5 border rounded-lg p-6">
            ...
            <div className="shadow-md bg-white flex justify-between mt-8 gap-5 flex-wrap">
                <div className="flex gap-3 p-4">
                    ...
                    <p className="font-inter font-bold">{beds} <span className="text-base font-normal text-[#303030]">Beds</span></p>
                </div>
                <div className="flex gap-3 p-4">
                    <FaBath className="text-2xl text-[#1c1b1f]" />
                    <p className="font-inter font-bold">{bath} <span className="text-base font-normal text-[#303030]">Bath</span></p>
                </div>
                <div className="flex gap-3 p-4">
                    <BsShopWindow className="text-2xl text-[#1c1b1f]" />
                    <p className="font-inter font-bold">{balcony} <span className="text-base font-normal text-[#303030]">Balcony</span></p>
                </div>
                <div className="flex gap-3 p-4">
            ...
            <div>
                <div className="mt-8 grid grid-cols-1 md:grid-cols-3 xl:grid-cols-7 gap-10">
                    <div className="w-full col-span-2">
                        ...
                        <h2 className="text-[#101010] font-medium text-nowrap">{area} sqft</h2>
                        <p className="text-[#535353] text-nowrap">${costperarea} / sqft</p>
                    </div>
                    <div className="w-full col-span-2">
                    ...
                    <div className="w-full col-span-1">
                        ...
                        <h2 className="text-[#101010] font-medium">{lift}</h2>
                    </div>
                </div>
                <div className="mt-8 grid grid-cols-1 md:grid-cols-3 xl:grid-cols-7 gap-10">
                    <div className="w-full col-span-2">
