    ...
    return (
        <div>
            <div className="container mx-auto px-5 mt-[64px]">
                <div>
                    <div className="flex justify-between gap-5 flex-col lg:flex-row">
                        ...
                        <div>
                            ...
                            <h3 className="max-w-[580px] font-bold text-[28px] md:text-[40px] mt-[20px] text-black leading-[52px] font-inter">Efficient and Transparent Home Buying Solutions</h3>
                ...
                <div>
                    <div className="flex justify-between gap-5 flex-col lg:flex-row mt-[120px]">
                        <div>
                            <div className="flex gap-2 items-center">
                                <div className="h-[3px] w-12 bg-[#F06711]"></div>
                                <p className="font-inter text-lg font-semibold text-[#F06711]">Property Buying</p>
