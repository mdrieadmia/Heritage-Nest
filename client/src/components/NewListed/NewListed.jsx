...
import useNewlistedPorperties from '../../hooks/useNewlistedPorperties';
import { TbFidgetSpinner } from 'react-icons/tb';
import { Link } from 'react-router-dom';

const NewListed = () => {

    const [newlistedProperties, isLoading] = useNewlistedPorperties()
    ...
    return (
        <div className="container mx-auto px-5 mt-32">
            <div className="flex justify-between items-center flex-wrap gap-5">
                ...
                <Link to={'/all'}><p className="cursor-pointer font-semibold font-poppins underline text-[#0059b1] text-[18px] text-nowrap">See all property</p></Link>
            </div>
            <div className='mt-8'>
                <Swiper
                    spaceBetween={30}
                ...
                >
                    {
                        newlistedProperties.map(popular => {
